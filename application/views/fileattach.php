                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-wrap">
                                            ...
                                            <div class="file-image-1">
                                                <a href="filemanager-details.html"><img src="../assets/images/media/files/doc.png" alt=""></a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0)" class="btn bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                    <li><a href="filemanager-details.html" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                            ...
                                            <div class="file-image-1">
                                                <a href="filemanager-details.html"><img src="../assets/images/media/files/file2.png" alt=""></a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0)" class="btn bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                    <li><a href="filemanager-details.html" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                            ...
                                            <div class="file-image-1">
                                                <a href="filemanager-details.html"><img src="../assets/images/media/files/file.png" alt=""></a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0)" class="btn bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                    <li><a href="filemanager-details.html" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
