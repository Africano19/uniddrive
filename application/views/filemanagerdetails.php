                                        ...
                                        <div class="owl-carousel owl-carousel-icons2">
                                            <div class="item">
                                                <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                    <a href="filemanager-details.html"><img src="../assets/images/media/files/03.jpg" alt="img" height="124" class="w-100"></a>
                                            ...
                                            <div class="item">
                                                <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                    <a href="filemanager-details.html"><img src="../assets/images/media/files/07.jpg" alt="img" height="124" class="w-100"></a>
                                                    <div class="card-footer">
                                                        <div class="d-flex">
                                                            <div class="">
                                            ...
                                            <div class="item">
                                                <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                    <a href="filemanager-details.html"><img src="../assets/images/media/files/06.jpg" alt="img" height="124" class="w-100"></a>
                                                    <div class="card-footer">
                                                        <div class="d-flex">
                                                            <div class="">
                                            ...
                                            <div class="item">
                                                <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                    <a href="filemanager-details.html"><img src="../assets/images/media/files/02.jpg" alt="img" height="124" class="w-100"></a>
                                                    <div class="card-footer">
                                                        <div class="d-flex">
                                                            <div class="d-flex">
                                                                <h5 class="mb-0 fw-semibold text-break">image1.jpg</h5>
